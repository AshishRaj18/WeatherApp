...
import com.ashish.weatherapp.Utilities.APIUtilities
import com.ashish.weatherapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //we can do this because of data binding which we have implemented in manifest file
        ...
        if (checkPermissions()) {
            if (isLocationEnabled()) {
                ...
                fusedLocationProviderClient.lastLocation.addOnCompleteListener(this) { task ->
                    ...
                    if (location == null) {
                        Toast.makeText(this, "Some issuse occured", Toast.LENGTH_SHORT).show()
                    } else {
                        //fetch weather here
                ...
                //open settings to enable the location
    ...
    private fun fetchCurrentLocationWeather(latitude: String, longitude: String) {
        ...
        activityMainBinding.pbLoading.visibility = View.VISIBLE
        APIUtilities.getAPI_Interface()?.getCurrentWeatherData(latitude, longitude, API_KEY)
    ...
    companion object {
        ...
        private const val API_KEY = "06d07d50e6d0f4bf91cd24c2a4985950"
